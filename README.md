...
This repository hosts an application developed with **besser** that provides answers to questions regarding the Luxembourg Constitution. The application leverages the latest official consolidated versions of the Constitution, allowing users to access up-to-date information and direct links to official documents on the [Legilux portal](https://legilux.public.lu).

## How It Works

- **Startup and Version Info:**  
  Upon launch, the application fetches information about the latest consolidation versions of the Luxembourg Constitution with a SPARQL query to the endpoint [Casemates](https://data.legilux.public.lu/sparqlendpoint). Users are shown these details, including links to view the documents directly on [Legilux](https://legilux.public.lu).
...
- **Akomantoso XML Format:**  
  The document of the Constitution is provided in the [Akomantoso](https://www.oasis-open.org/standard/akn-v1-0/) XML format, obtained from the official Legilux portal.  
